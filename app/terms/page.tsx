  ...
  return (
    <div className="min-h-screen py-12 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10 text-slate-300">
      <div className="max-w-3xl mx-auto">
        <Link href="/" className="inline-flex items-center text-[11px] uppercase tracking-widest text-cyan-400 hover:text-cyan-300 transition-colors mb-8 sm:mb-12 font-bold group">
          <ArrowLeft className="w-4 h-4 mr-2 transform group-hover:-translate-x-1 transition-transform" />
          Back to Search
        </Link>
        
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-white mb-8 sm:mb-12 tracking-tight sm:tracking-tighter">Terms of Service.</h1>
